...
| `service.httpPort` | HTTP port for accessing Portainer Web | `9999` |
| `service.httpNodePort` | Static NodePort for accessing Portainer Web. Specify only if the type is NodePort | `nil` |
| `service.edgePort` | TCP port for accessing Portainer Edge | `8888` |
...
| `ingress.hosts.paths.port` | Port for the Portainer Web. | `9999` |
